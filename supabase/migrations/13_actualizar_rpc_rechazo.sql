-- Migración 13: Actualizar RPC aprobar_solicitud_acceso con p_motivo_rechazo opcional
-- No agrega columna a la tabla; el motivo se usa solo para trazabilidad en el return JSON
